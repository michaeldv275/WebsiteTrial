...
import edu.webapde.dto.service.GradeRetriever;
...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		float grade = Integer.parseInt(request.getParameter("grade"));
		
		Grade g = new Grade(idnum, course, type, grade);
		
                new GradeRetriever().addGrade(g);
		
		request.getRequestDispatcher("GradeCheckerServlet").forward(request,  response);
    }
